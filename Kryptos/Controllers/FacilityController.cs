...
namespace Kryptos.Controllers
{
    public class FacilityController : Controller
    {
        ...
        public ActionResult CheckIfValidFacilityName(string facility)
        {
            ...
            if (facilityid == 0) res = _context.FacilityMasters.SingleOrDefault(x => x.FacilityMasterName == name);
            else res = _context.FacilityMasters.SingleOrDefault(x =>x.FacilityMasterName==name && x.FacilityMasterId != facilityid);
        ...
        public ActionResult CheckIfValidEmail(string email2)
        {
            ...
            var res = facilityMasterId == 0 ? _context.FacilityMasters.SingleOrDefault(x => x.Email == email) : _context.FacilityMasters.SingleOrDefault(x => x.Email == email && x.FacilityMasterId != facilityMasterId);
        ...
        public ActionResult CheckIfValidContactNumber(string phonenumber)
        {
            ...
            int facilityMasterId = int.Parse(strings[1]);
            var res = facilityMasterId == 0 ? _context.FacilityMasters.SingleOrDefault(x => x.Phone == phonenum) : _context.FacilityMasters.SingleOrDefault(x => x.Phone == phonenum && x.FacilityMasterId != facilityMasterId);
